...
public class CsvCensor {
    public static void main(String[] args) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/com/json/iplcensoranalyzer/ipl.csv"));
            BufferedWriter writer = new BufferedWriter(new FileWriter("src/com/json/iplcensoranalyzer/censored_ipl.csv"));
